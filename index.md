![Logo du hackaton](/docs/assets/images/banniere_hackaton_v4.jpg)
Bonjour à tous 👋

La Direction Générale des Finances Publiques ("DGFiP") organise un hackathon visant à mettre en valeur ses données ouvertes. Cette compétition se tiendra du 22 avril au 20 mai 2022.
...
La DGFiP participe à la gestion des finances publiques en France, en matière de dépenses et de recettes : elle gère notamment la fiscalité de l’État et des collectivités territoriales qui s’impose aux particuliers et aux entreprises, en assure le recouvrement au moyen de son réseau territorial.

Elle est placée sous la tutelle du ministère de l'Économie, des Finances et de la Relance ("MEFR"). 

La Délégation à la Transformation numérique (“DTNum”) mène la transformation numérique de la DGFiP. Une cinquantaine de personnes travaillent au sein de trois pôles dédiés: Données (open data, datascience), Culture numérique, et Expérience utilisateur.
...
Les candidats peuvent s’ils le souhaitent composer leur propre sujet à :ajpartir de leur analyse des ressources à disposition.
...
Si le format de restitution est laissé à la discrétion des candidats, la solution de BI Tableau doit être privilégiée pour les projets consistant en des visualisations de données.

Les candidats peuvent créer un compte gratuit [ici](https://public.tableau.com/en-us/s/).

Le dashboard à réaliser devra comporter le tag #OpenDataDGFiP
...
- Les nom, prénom, email, téléphone de chaque membre de l’équipe
